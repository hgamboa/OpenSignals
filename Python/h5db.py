...
class hdf:
    ...
    def addSignalRT(self, signalType='', mdata=None, dataName=None, blockShape=None, axis=0, dtype='f8'):
        """
        ...
        return realTime(group, mdata, dataName, blockShape, axis, dtype)
...
class realTime():
    ...
    def __init__(self, group, mdata, dataName, blockShape, axis, dtype):
        """
        ...
        # create dataset
        dset = group.create_dataset(dataName, blockShape, dtype, maxshape=mxs)
